...
Deno.test("p1 test", () => {
  assertEquals(problem1(testInputP1), 6440);
});

Deno.test("p2 test", () => {
  assertEquals(problem2(testInputP2), 5905);
});

Deno.test("p1 solution", () => {
  assertEquals(problem1(input), 249638405);
});
Deno.test("p2 solution", () => {
  assertEquals(problem2(input), 249776650);
});
